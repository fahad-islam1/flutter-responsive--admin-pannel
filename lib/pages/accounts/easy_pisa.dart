...
class EasyPisa extends StatefulWidget {
  final GlobalKey<ScaffoldState> scaffoldKey;

  const EasyPisa({super.key, required this.scaffoldKey});

  @override
  State<EasyPisa> createState() => _EasyPisaState();
}

class _EasyPisaState extends State<EasyPisa> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: Responsive.isMobile(context) ? 20 : 30),
              Text('Easy Pisa', style: TextStyle(
                  fontSize: 20,
