...
class BankTranscation extends StatefulWidget {
  final GlobalKey<ScaffoldState> scaffoldKey;

  const BankTranscation({super.key, required this.scaffoldKey});

  @override
  State<BankTranscation> createState() => _BankTranscationState();
}

class _BankTranscationState extends State<BankTranscation> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: Responsive.isMobile(context) ? 20 : 30),
              Text('Bank Transaction', style: TextStyle(
                  fontSize: 20,
